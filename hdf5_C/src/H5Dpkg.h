...
typedef herr_t (*H5D_layout_get_offsets_func_t)(struct H5D_io_info_t *io_info,
    const H5D_type_info_t *type_info, hsize_t nelmts, const H5S_t *file_space,
...
typedef ssize_t (*H5D_layout_get_offsetsvv_func_t)(
      const struct H5D_io_info_t *io_info, size_t mem_max_nseq, 
      size_t *mem_curr_seq, size_t mem_len_arr[], hsize_t mem_offset_arr[], 
      size_t *write_buf_off, size_t elmt_size);
...
typedef struct H5D_layout_ops_t {
    ...
    H5D_layout_get_offsets_func_t ser_get_offsets;      /* High-level I/O routine for getting coordinate offsets */
    H5D_layout_get_offsetsvv_func_t get_offsetsvv;    /* Low-level I/O routine for getting coordinate offsets */
} H5D_layout_ops_t;
...
typedef herr_t (*H5D_io_single_write_func_t)(const struct H5D_io_info_t *io_info,
    const H5D_type_info_t *type_info,
    hsize_t nelmts, const H5S_t *file_space, const H5S_t *mem_space);
typedef herr_t (*H5D_io_get_offsets_func_t)(const struct H5D_io_info_t *io_info,
    const H5D_type_info_t *type_info,
...
typedef struct H5D_io_ops_t {
    ...
    H5D_layout_get_offsets_func_t multi_get_offsets;  /* High-level I/O routine for getting offsets */
    ...
    H5D_io_get_offsets_func_t get_offsets;      /* routine to get offsets for selections */
} H5D_io_ops_t;
...
H5_DLL herr_t H5D_select_write(const H5D_io_info_t *io_info,
    const H5D_type_info_t *type_info,
    hsize_t nelmts, const H5S_t *file_space, const H5S_t *mem_space);
H5_DLL herr_t H5D_select_get_offsets(const H5D_io_info_t *io_info,
    const H5D_type_info_t *type_info,
    hsize_t nelmts, const H5S_t *file_space);
...
H5_DLL herr_t H5D_contig_get_offsets(H5D_io_info_t *io_info, const H5D_type_info_t *type_info,
    hsize_t nelmts, const H5S_t *file_space, H5D_chunk_map_t *fm);
