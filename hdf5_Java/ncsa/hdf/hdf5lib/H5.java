...
public class H5 implements java.io.Serializable {
    ...
    public static void loadH5Lib() {
        ...
        /*
        // call the C call that does a RTLD_GLOBAL load
        int loadRetVal = 0;

        try {
          loadRetVal = loadGlobalLibraries();
        } catch( HDF5LibraryException le ) { 
          le.printStackTrace();
          System.out.println("minor error: " + 
                             le.getMinorError(le.getMinorErrorNumber()));
        } finally{
          if( loadRetVal != 0)  { 
            s_logger.log(Level.SEVERE, "Failed to load native libraries; load returned" + 
                        loadRetVal);
            return;
          } 
        }
...
public synchronized static native int H5Dget_offsets(int dataset_id, int mem_type_id,
        int file_space_id, int xfer_plist_id, long[] buf, boolean isCriticalPinning)
        throws HDF5LibraryException, NullPointerException;

public synchronized static int H5Dget_offsets(int dataset_id, int mem_type_id,
        int file_space_id, int xfer_plist_id, long[] buf)
        throws HDF5LibraryException, NullPointerException
{
    return H5Dget_offsets(dataset_id, mem_type_id, file_space_id, xfer_plist_id, buf, true);
}
...
public synchronized static int H5Dget_offsets(int dataset_id, int mem_type_id,
        ...
        throws HDF5LibraryException, NullPointerException
{
    return H5Dget_offsets(dataset_id, mem_type_id, file_space_id, xfer_plist_id, obj, true);
}
*/
...
//public synchronized static native int H5Pset_fapl_ceph(int fapl_id,
//        String ceph_conf_path)
//        throws HDF5LibraryException, NullPointerException;
...
//public synchronized static native int loadGlobalLibraries() 
 //     throws HDF5LibraryException;
}
